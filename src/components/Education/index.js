...
const Education=()=>{
    return(
        ...
        <div className="educationDetailsContainer">
            <div>
            <h1 className="institute">Rajiv Gandhi University of Knowledge Technologies - Nirmal, Hyderabad</h1>
        <p className="branch">Graduation - Metallurgical and Materials Engineering, 8.61</p>
            </div>
        ...
        <div className="educationDetailsContainer">
            <div>
            <h1 className="institute">Z P High School, Allaparru - Guntur, Andhra Pradesh</h1>
